...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CyclicBarrier cyclicBarrier2 = new CyclicBarrier(NUMBER_OF_CYCLIST, new OpenedBarrierStageTwo());
        CyclicBarrier cyclicBarrier3 = new CyclicBarrier(NUMBER_OF_CYCLIST, new OpenedBarrierStageThree());
